...
import com.taoyuan.framework.bs.mail.impl.message.MessageSend;
import com.taoyuan.framework.bs.mail.config.ConfigFactory;
...
@Slf4j
@RestController
public class TyVerificationCodeController extends TyBaseController {
    ...
    public TyResponse getMailVerificationCode(@RequestBody TyVerificationCode tyVerificationCode) {
        ...
        AppConfig config = ConfigFactory.getConfig(ConfigFactory.ConfigType.Message);
