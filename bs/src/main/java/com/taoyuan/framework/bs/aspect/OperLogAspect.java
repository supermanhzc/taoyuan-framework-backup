...
import com.taoyuan.framework.common.exception.TyException;
...
public class OperLogAspect {
    ...
    public Object recordOperLog(ProceedingJoinPoint joinPoint) throws Throwable{
        ...
        request.setAttribute("operlog", tyOperLog);
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable e) throws Throwable{
        ...
        TyOperLog tyOperLog = (TyOperLog) request.getAttribute("operlog");
        tyOperLog.setEndTime(new Date());
        if(e instanceof TyException){
            TyException tyException = (TyException) e;
            tyOperLog.setRespCode(tyException.getCode().toString());
            tyOperLog.setRespMessage(tyException.getMessage());
        } else{
