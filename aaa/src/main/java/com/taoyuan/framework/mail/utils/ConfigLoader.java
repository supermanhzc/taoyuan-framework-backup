package com.taoyuan.framework.mail.utils;

import java.io.IOException;
import java.util.Properties;

import com.taoyuan.framework.mail.config.AppConfig;
import com.taoyuan.framework.mail.config.InternationalsmsConfig;
import com.taoyuan.framework.mail.config.MailConfig;
import com.taoyuan.framework.mail.config.MessageConfig;
import com.taoyuan.framework.mail.config.MobiledataConfig;
import com.taoyuan.framework.mail.config.VoiceConfig;
